...
[_QWERTY] = {
  ...
  {KC_LGUI, KC_RCTL, KC_LALT, KC_LSFT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
[_GAMING] = {
  ...
  {KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_SPC,  KC_SPC,  KC_M,    KC_COMM, KC_DOT,  KC_SLSH, EXIT   },
},
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |  F11 |  F12 |Aud on|Audoff|AGnorm|AGswap|Qwerty|Gaming|      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = {
  ...
  {_______, KC_F11,  KC_F12,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  GAMING,  _______, _______, _______},
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case GAMING:
      if (record->event.pressed) {
        #ifdef AUDIO_ENABLE
          PLAY_NOTE_ARRAY(tone_gaming, false, 0);
        #endif
        layer_clear();
        layer_on(_GAMING);
      }
